<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <input id="age" name="age" type="number" v-model.number="age" ref="age" @blur="valiageInput" />
      <p v-if="isAgeValid === false">Age is invalid under the input</p>
    </div>
    <div class="form-control">
    ...
    <div class="form-control">
      ...
      <input id="comment" name="comment" type="textarea" v-model="comment" />
    </div>
    <div>
